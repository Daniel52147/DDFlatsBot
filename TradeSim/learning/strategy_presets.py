...
STRATEGY_PRESETS: dict[str, dict[str, dict[str, float]]] = {
    "dca": {
        "aggressive": {
            ...
            "dca_interval_hours": 0.3,
            "dip_cooldown_minutes": 0.4,
            "spike_cooldown_minutes": 0.4,
    ...
    "grid": {
        "aggressive": {
            "grid_spacing_pct": 0.85,
            "grid_buy_amount": 1.3,
            "grid_sell_fraction": 0.9,
            "grid_cooldown_minutes": 0.4,
            "dca_interval_hours": 0.35,
        },
